							...
							<div class="_dashboard_content bg-white rounded mb-4">
								<div class="_dashboard_content_header br-bottom py-3 px-3">
									<div class="_dashboard__header_flex">
										<h4 class="mb-0 ft-medium fs-md"><i class="fa fa-file mr-1 theme-cl fs-sm"></i>Create Company</h4>
									</div>
								</div>
											...
											<div class="row">
												...
												<div class="col-xl-12 col-lg-12 col-md-12">
													<div class="form-group">
														...
														<input type="text" class="form-control rounded" value="" name="name" placeholder="Company Name" required>
													</div>
												</div>
												...
												<div class="col-xl-6 col-lg-6 col-md-6">
													<div class="form-group">
														...
														<input type="text" class="form-control rounded" value="" name="email" placeholder="Email" required>
													</div>
												</div>
												...
												<div class="col-xl-6 col-lg-6 col-md-6">
													<div class="form-group">
														...
														<input type="number" class="form-control rounded" value="" name="contact" placeholder="Contact" required>
													</div>
												</div>
												...
												<div class="col-xl-6 col-lg-6 col-md-6">
													<div class="form-group">
														...
														<input type="text" class="form-control" value="" placeholder="City" name="city" required />
													</div>
												</div>
												...
												<div class="col-xl-12 col-lg-12 col-md-12">
													<div class="form-group">
														...
														<input type="text" class="form-control" value="" placeholder="#10 Marke Juger, SBI Road" name="address" required />
													</div>
												</div>
												...
												<div class="col-xl-12 col-lg-12 col-md-12">
													<div class="form-group">
														...
														<textarea class="form-control rounded" placeholder="Company Description" name="about" required></textarea>
													</div>
												</div>
												...
												<div class="col-xl-4 col-lg-6 col-md-6">
													<div class="form-group">
														...
														<input type="text" class="form-control" value="" placeholder="Award" name="award" required />
													</div>
												</div>
												...
												<div class="col-xl-4 col-lg-6 col-md-6">
													<div class="form-group">
														...
														<input type="number" class="form-control" value="" placeholder="Year" name="award_year" required />
														<code>e.g 2020</code>
													</div>
												</div>
												...
												<div class="col-xl-12 col-lg-12 col-md-12">
													<div class="form-group">
														...
														<textarea class="form-control rounded" value="" rows="2" placeholder="Awards Description" name="award_disc" required></textarea>
													</div>
												</div>
												...
												<div class="col-12">
													<div class="form-group">
														<button type="submit" name="add_company" class="btn btn-md ft-medium text-light rounded theme-bg">Add Company</button>
													</div>
												</div>
