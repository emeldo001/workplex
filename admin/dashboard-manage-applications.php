                                    ...
                                    <div class="row align-items-center justify-content-between">
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-5 col-sm-12">
                                            <?php
												...
												if ($count > 0) { ?>
                                            <h6 class="mb-0 ft-medium fs-sm"><?php echo $count ?> New Applicants Found
                                            </h6>
                                            <?php } ?>
                                        </div>
                                        <?php } else { ?>
                                        ...
                                        <div class="col-xl-9 col-lg-8 col-md-7 col-sm-12">
                                            <div
                                                class="filter_wraps elspo_wrap d-flex align-items-center justify-content-end">
                                                <div class="single_fitres mr-2">
                                                    <form method="post">
														...
														?>
                                                        <select class="custom-select simple" onchange="submit()"
                                                            name="sort">
                                                            <?php
															if ($sort == "DESC") { ?>
                                                            ...
                                                            <?php } else { ?>
                                                            <option value="" selected="">Default Sorting (Highest Score)
                                                            </option>
                                                            <option value="DESC">Sort By Recent</option>
                                                            <option value="ASC">Sort By Older</option>
                                                            <?php } ?>
                                ...
                                <div class="dashed-list-wrap bg-white rounded mb-3">
                                    <div class="dashed-list-full bg-white rounded p-3 mb-3">
                                        <div class="dashed-list-short d-flex align-items-center">
                                            <div class="dashed-list-short-first">
                                                <div class="dashed-avater">
                                                    <img src="../<?php echo $APPLICANTPHOTO ?>" class="img-fluid circle"
                                                        width="70" alt="" />
                                                </div>
                                            </div>
                                            <div class="dashed-list-short-last">
                                                <div class="cats-box-caption px-2">
                                                    <h4 class="fs-lg mb-0 ft-medium theme-cl">
                                                        <?php echo $FNAME . ' ' . $OTHERNAMES ?></h4>
                                                    <div class="d-block mb-2 position-relative">
                                                        <span><i class="lni lni-map-marker mr-1"></i>
                                                            <?php echo $CITY ?>, <?php echo $COUNTRY ?></span>
                                                        <span class="ml-2"><i
                                                                class="lni lni-briefcase mr-1"></i><?php echo $JOBTITLE ?></span>
                                                    </div>
                                                    <div class="ico-content">
                                                        <ul>
                                                            <?php if ($APPLICATIONSTATUS == "Pending") { ?>
                                                            <li><span
                                                                    class="px-2 py-1 medium bg-light-success rounded text-warning"><i
                                                                        class="fa fa-minus mr-1"></i>
                                                                    <?php echo $APPLICATIONSTATUS ?></span></li>
                                                            <?php } elseif ($APPLICATIONSTATUS == "Approved") { ?>
                                                            <li><span
                                                                    class="px-2 py-1 medium bg-light-success rounded text-info"><i
                                                                        class="fa fa-check mr-1"></i>
                                                                    <?php echo $APPLICATIONSTATUS ?></span></li>
                                                            <?php } elseif ($APPLICATIONSTATUS == "Reviewed") { ?>
                                                            <li><span
                                                                    class="px-2 py-1 medium bg-light-success rounded text-secondary"><i
                                                                        class="fa fa-briefcase mr-1"></i>
                                                                    <?php echo $APPLICATIONSTATUS ?></span></li>
                                                            <?php } elseif ($APPLICATIONSTATUS == "Hire") { ?>
                                                            <li><span
                                                                    class="px-2 py-1 medium bg-light-success rounded text-success"><i
                                                                        class="fa fa-check-circle mr-1"></i>
                                                                    <?php echo $APPLICATIONSTATUS ?></span></li>
                                                            <?php } else { ?>
                                                            <li><span
                                                                    class="px-2 py-1 medium bg-light-success rounded text-danger"><i
                                                            ...
                                                            <li>
                                                                <form method="post">
                                                                    <input type="hidden" name="resume_url"
                                                                        value="<?php echo $RESUME_FILE ?>">
                                                                    <button type="submit" name="download_resume"
                                                                        class="px-2 py-1 medium bg-light-success rounded text-success"
                                                                        style="border: none;"
                                                                        onclick="return confirm('You are about to download <?php echo $FNAME ?> Remsume/CV?');"><i
                                                                            class="lni lni-download mr-1"></i>Download
                                                                        CV</button>
                                                                </form>
                                                            ...
                                                            <li><a href="javascript:void(0);"
                                                                    class="px-2 py-1 medium bg-light-info rounded text-info"
                                                                    onclick="message()" id="showmsg"><i
                                                                        class="lni lni-envelope mr-1"></i>Message</a>
                                                            </li>

                                                            <li><a href="javascript:void(0);"
                                                                    class="px-2 py-1 medium bg-light-info rounded text-info"
                                                                    onclick="unsetmsg()" id="hidemsg"><i
                                                                        class="lni lni-envelope mr-1"></i>X</a></li>


                                                            <li><i class="lni lni-book mr-1"></i>Screening Score:
                                                                <?php if ($total_ques != 0) echo $score . '/' . $total_ques ?>
                                                            </li>
                                                            <li><i class="lni lni-book mr-1"></i>Score Percentage:
                                                                <?php if ($total_ques != 0) echo ($score / $total_ques) * 100 . '%' ?>
                                                            </li>
                                                            <li><a href="dashboard-view-application-screening.php?jopapp_id=<?php echo $ID?>"
                                                                    class="px-2 py-1 medium  rounded text-success"><i
                                                                        class="lni lni-eye mr-1"></i>View Screening</a>
                                                            </li>
                                        ...
                                        <div class="dashed-list-last">
                                            <div class="text-left">
                                                ...
                                                <form method="post">
                                                    <select class="btn gray ft-medium apply-btn fs-sm rounded mr-1"
                                                        name="applicationstatus" onchange="submit()">
                                                        <option value="<?php echo $APPLICATIONSTATUS ?>" hidden>
                                                    ...
                                                    <a href="?type=delete&bookmarkedid=<?php echo $bk_ID ?>&jobid=<?php echo $JOBID ?>"
                                                        class="btn gray ft-medium apply-btn fs-sm rounded text-warning"><i
                                                            class="lni lni-heart mr-1"></i>Saved</a>

                                                    <?php } else { ?>
                                                    <button type="submit" name="save_resume"
                                                        class="btn gray ft-medium apply-btn fs-sm rounded"><i
                                                            class="lni lni-heart mr-1"></i>Save</button>
                                                    <?php } ?>

                                                    <a href="dashboard-candidate-detail.php?applicantid=<?php echo $APPLICANTID ?>&jobapplicationid=<?php echo $ID ?>"
                                                        class="btn gray ft-medium apply-btn fs-sm rounded"><i
                                                            class="lni lni-eye mr-1"></i> Candidate</a>
                                                </form>
                                                ...
                                                <div class="modal-body p-5" id="msg">
                                                    <form method="post">
                                                        <input type="hidden" name="userID"
                                                            value="<?php echo $APPLICANTID ?>">
                                                        <div class="form-group">
                                                            <textarea class="ht-200 form-control"
                                                        ...
                                                        <div class="form-group">
                                                            <button type="submit" name="send_msg"
                                                                class="btn btn-md full-width theme-bg text-light fs-md ft-medium">Send
                                                                Message</button>
                                                        </div>
                                                    </form>
                                                </div>
                                                ...
                                                <div class="modal-body p-5" id="note">
                                                    <form method="post">
                                                        ...
                                                        <div class="form-group">
                                                            <button type="submit" name="send_note"
                                                                class="btn btn-md full-width theme-bg text-light fs-md ft-medium">Save
                                                                Note</button>
                                                        </div>
                                                    </form>
                                                </div>
                                    ...
                                    <div class="dashed-list-footer p-3 br-top">
                                        ...
                                        <div class="ico-content">
                                            <ul>
                                                <li><span><i
                                                            class="lni lni-calendar mr-1"></i><?php echo $DATEPOSTED ?></span>
                                                </li>
                                                <li><span><i
                                                            class="lni lni-add-files mr-1"></i><?php echo timeago($DATEPOSTED) ?></span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
            ...
            <div class="modal-content" id="messagemodal">
                ...
                <div class="modal-body p-5">
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-md full-width theme-bg text-light fs-md ft-medium">Send
                                Message</button>
                        </div>
                    </form>
                </div>
            ...
            <div class="modal-content" id="appeditmodal">
                ...
                <div class="modal-body p-5">
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-md full-width theme-bg text-light fs-md ft-medium">Save
                                Status</button>
                        </div>
                    </form>
                </div>
