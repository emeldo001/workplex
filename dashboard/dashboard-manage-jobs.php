										...
										<tbody>
											...
											?>
												<tr>
													...
													<td>
														<?php if ($count > 0) { ?>
															<a href="dashboard-manage-applications.html" class="theme-bg text-light rounded px-3 py-2 ft-medium">Total <?php echo $count ?></a>
														<?php } else { ?>
													...
													<td>
														<div class="dash-action">
															<a href="../job-detail.php?jobid=<?php echo $row['JOBID']; ?>" class="p-2 circle text-info bg-light-info d-inline-flex align-items-center justify-content-center mr-1"><i class="lni lni-eye"></i></a>
