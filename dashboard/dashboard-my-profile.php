											...
											<div class="row">
												...
												<div class="col-xl-6 col-lg-6">
													<div class="form-group">
														...
														<input type="text" class="form-control rounded" placeholder="First Name" name="FName" value="<?php if (!empty($FNAME)) echo $FNAME; ?>">
													</div>
												</div>
												<div class="col-xl-6 col-lg-6">
													<div class="form-group">
														<label class="text-dark ft-medium">Other Names</label>
														<input type="text" class="form-control rounded" placeholder="Other Names" name="OName" value="<?php if (!empty($ONAME)) echo $ONAME; ?>">
													</div>
												</div>
												<div class="col-xl-12 col-lg-12 col-12">
													<div class="form-group">
														<label class="text-dark ft-medium">Email</label>
														<input type="email" class="form-control rounded" name="email" value="<?php if (!empty($EMAIL)) echo $EMAIL; ?>">
													</div>
												</div>
												<div class="col-xl-6 col-lg-6">
													<div class="form-group">
													...
													<div class="form-group">
														...
														<select class="form-control rounded" name="job_categoryid" required>
															<?php if (!empty($JOBCATEGORYID)) { ?>
																<option value="<?php echo $JOBCATEGORYID ?>" selected hidden><?php echo $SUBCATEGORY ?></option>
															<?php } else { ?>
												...
												<div class="col-xl-12 col-lg-12">
													<div class="form-group">
															...
															<button type="submit" name="edit_data" class="btn btn-md ft-medium text-light rounded theme-bg">Update Data</button>
					...
					?>
						...
						<form method="post">
							...
							<div class="col-xl-12 col-lg-12">
								<div class="form-group">
										...
										<button type="submit" name="edit_info" class="btn btn-md ft-medium text-light rounded theme-bg">Update Info</button>
						...
						?>
							...
							<form method="post">
															...
															<div class="form-group">
																...
																<select class="custom-select rounded" name="company_name_select" id="company_select" onchange="set_company()">
																	...
																	<?php if (!empty($EXCOMPANYNAME)) { ?>
																		<option value="<?php echo $EXCOMPANYNAME ?>" hidden><?php echo $EXCOMPANYNAME ?></option>
																	<?php } else { ?>
								...
								<div class="row">
									<div class="col-lg-12 col-md-12">
										<button type="submit" name="edit_preview" class="btn btn-md ft-medium text-light rounded theme-bg">Update Details</button>
									</div>
								</div>
							</form>
					<?php }
